...
namespace Workflow.Controllers.Filters.Exceptions
{
    ...
    public class WorkflowExceptionHandlerAttribute : Attribute, IAsyncExceptionFilter
    {
        ...
        {
            _logger = _logger ?? 
                context.HttpContext.RequestServices.GetService(typeof(ILogger<WorkflowExceptionHandlerAttribute>)) as ILogger;
