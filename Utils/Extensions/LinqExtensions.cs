namespace Utils
{
    ...
    {
        public static IEnumerable<T> EmptyIfNull2<T>(this IEnumerable<T> src)
        {
        ...
        {
            return src.EmptyIfNull2().Any() ? src : null;
        }
        ...
        {
            return items.EmptyIfNull2().Contains(val);
        }
        ...
        public static bool IsDefault2<T>(this T val)
        {
